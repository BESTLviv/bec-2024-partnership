...
export const OPPORTUNITIES = [
    {
        image: opportunity1,
        text: "Залучитися до розвитку інженерної молоді України" 
    },
    {
        image: opportunity2,
        text: "Знайти нові погляди на розв’язання Вашої проблеми з допомогою студентів" 
    },
    {
        image: opportunity3,
        text: "Побачити та підтримати цікаві ідеї, що можуть стати в пригоді в майбутньому" 
    },
    {
        image: opportunity4,
        text: "Виявити таланти учасників та відібрати серед них перспективних працівників" 
    },
    {
        image: opportunity5,
...
export const SPECIALITY = [
    ...
    {
        text: "Системи штучного інтелекту" 
    },
    {
        text: "Кібербезпека" 
    },
