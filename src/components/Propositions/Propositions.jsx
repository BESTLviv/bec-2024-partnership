        ...
        <div ref={innerRef}>
            ...
            <div id="propositions" className="propositions relative  text-white mx-3 flex flex-col items-center lg:mx-[72px]">
                ...
                <div className=" relative px-[25px] lg:px-0 z-30 self-start lg:self-start  lg:mx-0">
                    {t("packets.discontText1")}<br />
                    {t("packets.discontText2")}<br />
            ...
            <div className="sub-propositions text-white mx-[25px] flex flex-col relative z-30 items-center mb-[150px]">
                ...
                <Title className="sub-propositions__title text-center mx-[50px] mb-[30px] lg:mb-[64px]">{t("addtitionalPropositions.title")}</Title>
                {addtitionalPropositions.map((proposition, index) => (
                    <SubProposition isMobile={isMobile} key={index} proposition={proposition} addToBasket={addToBasket} handleRemoveProposition={handleRemoveProposition} isActive={selectedPropositions.some(element => element.title === proposition.text)}></SubProposition>
                ))}
            </div>
        </div>
    );
