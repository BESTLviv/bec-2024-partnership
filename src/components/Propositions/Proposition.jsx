...
export function Proposition({ proposition, addToBasket, isActive, handleRemoveProposition }) {
    ...
    let classBlock = "transition-transform transform-gpu duration-[400ms] hover:scale-[1.05]  cursor-pointer  relative flex  flex-col cursor-pointer text-white mb-10 lg:mb-0 w-full lg:w-full lg:h-[515px] min-[2100px]:h-[555px] min-[2300px]:h-[585px] h-[456px]  px-[25px] lg:px-[63px] bg-proposition-gradient p-5  text-[12px] font-medium";
