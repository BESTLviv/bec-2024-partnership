...
export default function Aboutbest() {
    return (
        <div className=" flex flex-col relative text-white px-[25px] mb-[150px] lg:px-[180px] lg:items-center lg:mb-[500px] ">
            <Title className=" text-center px-[20px] mb-[30px] lg:mb-[54px]">ПРО BEST LVIV</Title>
