...
export default function Aboutbest() {
    return (
        <div className=" flex flex-col relative text-white px-[25px] mb-[150px]   ">
            ...
            <div className=" self-center bg-add-map bg-contain flex justify-center items-center w-[321px] h-[293px]  mb-[26px]" src={addMap} alt="" > <img className=" w-[276px] h-[252px] " src={map} alt="" /></div>
