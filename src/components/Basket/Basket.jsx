...
export default function Basket() {
    return (
        <>
            <div className="text-white mx-[30px] flex flex-col  ">
            ...
            <div className="text-white mx-[50px] flex flex-col border-2 border-white p-[30px] mb-[30px]">
                <div>
                ...
                <button className=" self-center text-white border-2 border-white flex justify-center items-center  h-[40px] w-[161px]">Оформити</button>

            </div>
            <div className=" text-white mx-[34px] mb-[150px]">
                <div className=" text-[24px] mb-[12px] font-daysOne ">Акції</div>
                <ol className=" text-[12px] w-[242px]">
