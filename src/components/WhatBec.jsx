...
export default function WhatBec() {
    ...
    return (
        <div className=" flex flex-col lg:items-center self-center relative text-white mb-[165px] px-[50px] pt-[160px] lg:pt-[250px]  mb-[165px] lg:mb-[250px] ">
            ...
            <button className=" transition-transform transform-gpu duration-[400ms] hover:scale-[1.1]  block border-2  border-customOrange text-white py-[10px] w-full h-[46px] text-[16px] lg:w-[359px]">Дізнатись більше</button>
        </div>
    );
}